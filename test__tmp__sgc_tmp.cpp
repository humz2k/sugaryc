...
typedef struct _ndarray<long int>* _LongIntArray;*/extern "C" void *malloc(int);
...
typedef struct _long_int_array *long_int_array;
...
long_int_array _make_long_int_array(int *dims, int ndims);
int *__index__(int_array arr, int *idxs, int nidx);
long int *__index__(long_int_array arr, int *idxs, int nidx);
